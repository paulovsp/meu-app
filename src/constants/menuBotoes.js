// Fonte única dos botões de navegação das abas Clínica/Financeiro —
...
export const CLINICA_BUTTONS = [
  ...
  { id: 'patients', icon: 'people-outline',    label: 'Analisantes', screen: 'Patients', corBadge: '#825F4D' },
  { id: 'relatorios', icon: 'document-text-outline', label: 'Relatórios', screen: 'Relatorios', corBadge: '#776746' },
];

// A aba deixou de se chamar "Administrativo" e virou "Financeiro" — e os
// rótulos passaram a dizer o que cada tela é, em vez de como o sistema a
// chama: o que entra (Entradas), o que sai (Saídas), e o que ainda está
// para entrar (Cobrança). A ORDEM importa: Entradas primeiro, no canto
// superior esquerdo, que é onde o olho começa.
export const ADMIN_BUTTONS = [
  { id: 'financeiro', icon: 'stats-chart-outline', label: 'Entradas',  screen: 'Financeiro', corBadge: '#567243' },
  { id: 'pagamentos', icon: 'wallet-outline',      label: 'Saídas',    screen: 'Pagamentos', corBadge: '#4B6B80' },
  { id: 'cobranca',   icon: 'cash-outline',        label: 'Cobrança',  screen: 'Cobranca',   corBadge: '#776746', corIcone: '#302C28' },
