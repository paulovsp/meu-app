...
const s = StyleSheet.create({
  ...
  mesBtn: { padding: 6 },
  mesLabel: { fontSize: 16, fontWeight: '700', color: COLORS.textDark, minWidth: 140, textAlign: 'center' },
  ...
  totalLabel: { fontSize: 12, color: 'rgba(255,255,255,0.75)', fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1 },
  totalValor: { fontSize: 28, fontWeight: '700', color: '#FFFFFF', marginTop: 6 },
  sectionTitle: { fontSize: 14, fontWeight: '700', color: COLORS.textDark, marginBottom: 8, marginTop: 4 },
  sistemaCard: {
  ...
  sistemaLabel: { fontSize: 13, color: COLORS.textMid },
  sistemaValor: { fontSize: 13, fontWeight: '700', color: COLORS.textDark },
  ...
  despesaDescricao: { fontSize: 14, fontWeight: '700', color: COLORS.textDark },
  despesaMeta: { fontSize: 12, color: COLORS.textMid, marginTop: 2 },
  despesaValor: { fontSize: 14, fontWeight: '700', color: COLORS.textDark },
  ...
  categoriaChipTexto: { fontSize: 12.5, fontWeight: '600', color: COLORS.textMid },
