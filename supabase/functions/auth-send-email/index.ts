    ...
    if (tipo === 'signup') {
      ...
      html = `
        <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; color: #302C28; line-height: 1.55;">
          ...
          <p style="font-size:12.5px;color:#6B6860;">Os três planos são assinatura e renovam sozinhos até você cancelar — muda só de quanto em quanto tempo a cobrança acontece. Pagamento em cartão de crédito, pelo Mercado Pago. Cancele quando quiser, sem multa.</p>
